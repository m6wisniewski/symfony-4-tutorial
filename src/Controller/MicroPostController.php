...
class MicroPostController {
    ...
    public function __construct(
            \Twig_Environment $twig, MicroPostRepository $microPostRepository, FormFactoryInterface $formFactory, EntityManagerInterface $entityManager, RouterInterface $router, FlashBagInterface $flashBag, AuthorizationCheckerInterface $authorizationChecker
            ){
        $this->twig = $twig;
    ...
    public function edit(MicroPost $microPost, Request $request){
        //Only for extended base controller
